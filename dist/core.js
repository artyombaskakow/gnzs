define(
  ['jquery', 'moment', 'lib/components/base/modal', 'underscore', 'https://cdn.jsdelivr.net/npm/object-hash@3.0.0/dist/object_hash.min.js'], 
  function($, moment, Modal, _, hash){
    ...
    const CORE = {
      ...
      async getAccountNotifications(widget) {
        ...
        const { notifications, cacheMinutes, showNextWatingSeconds = 3 } = await this._apiGet(
          widget,
          API_ACCOUNT_NOTIFICATIONS
        );
